...
$.extend($.validator, {
	...
	messages: {
		required: "Este campo &eacute; necess&aacute;rio.",
		...
		dateISO: "Por favor digite uma data (ISO) v&aacute;lida.",
		number: "Por favor digite um n&uacute;mero v&aacute;lido",
		digits: "Por favor, digite apenas n&uacute;meros.",
		creditcard: "Por favor digite um n&uacute;mero de cartao de credito v&aacute;lido.",
		equalTo: "Por favor digite o mesmo valor novamente.",
		maxlength: $.validator.format("Por favor, digite no m&aacute;ximo {0} caracteres."),
		minlength: $.validator.format("Por favor, digite no m&iacute;nimo {0} caracteres."),
		rangelength: $.validator.format("Por favor digite um valor de caracteres entre {0} e {1}."),
